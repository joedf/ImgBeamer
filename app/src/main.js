...
function OnImageLoaded(eImg, stages){
	...
	var updateResamplingSteps = function(){
		...
		var warnVSEM = (rows*cols > G_AUTO_PREVIEW_LIMIT);
		$(resampled_vSEM_note).toggle(warnVSEM);
	};
